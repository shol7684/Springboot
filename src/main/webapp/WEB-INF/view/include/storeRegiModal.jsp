		...
		<div class="modal_box modal2">
	         ...
	         <ul>
	            ...
	            <li class="location">
	                <label for="location">
	                    ...
	                    <div class="sample">
	                        ...
	                        <input type="text" value="" onclick="sample2_execDaumPostcode()" id="sample2_postcode" placeholder="우편번호" readonly name="storeAddress1" required>
	
	                        <input type="text" value="" onclick="sample2_execDaumPostcode()" id="sample2_address" placeholder="주소" readonly name="storeAddress2" required><br>
	                        <input type="text" value="" id="sample2_detailAddress" placeholder="상세주소" name="storeAddress3">
	            ...
	            <li>
	                ...
	                <div><input type="number" value="" id="storePhoneNumber" name="storePhone" required></div>
	            </li>
	            ...
	            <li>
	                ...
	                <div><input type="number" value="" id="minDeleveryPrice" name="minDelevery" required>원</div>
	            </li>
	            ...
	            <li>
	                ...
	                <div><input type="number" value="" id="deleveryTip" name="deleveryTip" required >원</div>
	            </li>
	            ...
	            <li>
	                ...
	                <div><input type="number" pattern="/d*" value="" id="deleveryTime" name="deleveryTime" required>분</div>
	            </li>
	             ...
	             <li>
	                ...
	                <div class="store_des"><textarea id="store_des" name="storeDes"></textarea></div>
